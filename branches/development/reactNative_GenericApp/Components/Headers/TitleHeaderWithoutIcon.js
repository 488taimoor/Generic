...
export default class TitleHeaderWithoutIcon extends Component {
    ...
    render() {
        ...
        const { backgroundColor = 'white', iconName1 = "navigate-before", iconSize1 = 34, iconColor1 = "#007AFF", iconHandler1, title = "Title", pageTitle = 'Inverter_T34_Sonex', titleColor = "#007AFF" } = this.props;
        ...
        return (
            ...
            <SafeAreaView style={[iconContainerStyle, { backgroundColor }]}>
                ...
                <View style={[iconContainerStyle1, { backgroundColor }]}>
                    ...
                    <Text style={pageTitleStyle}>{pageTitle.length > 18 ? pageTitle.substring(0, 18) + '...' : pageTitle}
                    </Text>
