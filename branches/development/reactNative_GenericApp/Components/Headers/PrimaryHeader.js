...
export default class PrimaryHeader extends Component {
    ...
    render() {
        ...
        const { backgroundColor="white", titleColor, iconName1 = "add", iconName2 = "notifications", iconSize1=20, iconSize2=20, iconColor1, iconColor2, iconDisplay1, iconDisplay2, iconHandler1, iconHandler2, title = "Page Title" } = this.props;
