...
class CardHosting extends Component {


    render() {
        const { enventName = 'Batch 43th Common, G2G', eventDesc = 'Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do', date = '23th June 2019', time = '05:00 pm', img = require('../images/logo.png'), name = 'Jane Smith', location = 'Pearl Continental' } = this.props
        const {
            ...
            <TouchableOpacity style={contentContainerStyle}>
                ...
                <View style={topViewStyle}>
                    ...
                    <View style={viewStyle1}>
                        <Text style={hostingStyle}>Hosting</Text>
                    </View>
                </View>
                {/* // todo: middle Text */}
